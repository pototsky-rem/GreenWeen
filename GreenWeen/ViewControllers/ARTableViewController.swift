    ...
    private let data: [Category] = [
        ...
        Category(arList: ArList(name: "Forsythia", shortDiscription: "Welcome Thuja"),
                 cellModel: [.collectionView(model: [
                    ...
                    CollectionTableCellModel(imageName: "forsythia9"),
                    CollectionTableCellModel(imageName: "forsythia10"),
                    CollectionTableCellModel(imageName: "forsythia11"),
                    CollectionTableCellModel(imageName: "forsythia12"),
                    CollectionTableCellModel(imageName: "forsythia13"),
                    CollectionTableCellModel(imageName: "forsythia14"),
                    CollectionTableCellModel(imageName: "forsythia15"),
                    CollectionTableCellModel(imageName: "forsythia16"),
                    CollectionTableCellModel(imageName: "forsythia17")], rows: 2),
        ...
        Category(arList: ArList(name: "Acacia", shortDiscription: "Welcome Thuja"),
                 cellModel: [.collectionView(model: [
                    ...
                    CollectionTableCellModel(imageName: "acacia9"),
                    CollectionTableCellModel(imageName: "acacia10"),
                    CollectionTableCellModel(imageName: "acacia11"),
                    CollectionTableCellModel(imageName: "acacia12"),
                    CollectionTableCellModel(imageName: "acacia13"),
                    CollectionTableCellModel(imageName: "acacia14"),
                    CollectionTableCellModel(imageName: "acacia15")], rows: 2),
